...
exports.Sandbox = class Sandbox extends EventEmitter {
  constructor (opts = {}) {
    ...
    this.opts = {
      ...
      nodeModulesPath: opts.nodeModulesPath && typeof opts.nodeModulesPath === 'string' ? opts.nodeModulesPath : NODE_MODULES_PATH,
      strace: !!opts.strace,
  ...
  async configContainer (params) {
    return await this._request(0, `__config_container`, params)
  }
    ...
    switch (method) {
      ...
      default: {
        ...
        if (typeof fn === 'function') {
          return pack(await fn(...(params || [])))
        } else {
          throw pack({message: `Function ${method} does not exist`})
        }
      }
    }
  }
...
(allow file-read* (subpath "${sbx.opts.nodeModulesPath}"))
